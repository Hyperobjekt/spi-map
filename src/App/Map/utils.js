  ...
  return [
    {
      ...
      maxzoom: 9,
      paint: {
        'circle-radius': ['interpolate', ['linear'], ['zoom'], 3, 2, 5, 4, 6, 8, 8, 10, 10, 10],
        'circle-color': ['case', ['!=', ['get', accessor(context)], null], fillRule, 'transparent'],
        'circle-opacity': ['interpolate', ['linear'], ['zoom'], 2, 0, 3, 1, 8, 1, 9, 0],
